...
export const OPTIONAL_WEB_CHAT_RUNNER_RUNTIME_CAPABILITIES = Object.freeze(
  normalizeList(runtimeManifest.optional_capabilities),
);
export const REQUIRED_WEB_CHAT_RUNNER_RUNTIME_PATHS = Object.freeze(
  normalizeList(runtimeManifest.required_paths),
);
export const OPTIONAL_WEB_CHAT_RUNNER_RUNTIME_PATHS = Object.freeze(
  normalizeList(runtimeManifest.optional_paths),
);
...
export const WEB_CHAT_RUNNER_RUNTIME_MANIFEST = Object.freeze({
  ...
  optional_capabilities: [...OPTIONAL_WEB_CHAT_RUNNER_RUNTIME_CAPABILITIES],
  required_paths: [...REQUIRED_WEB_CHAT_RUNNER_RUNTIME_PATHS],
  optional_paths: [...OPTIONAL_WEB_CHAT_RUNNER_RUNTIME_PATHS],
});
